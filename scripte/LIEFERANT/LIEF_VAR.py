...
srcFile = os.getcwd()+"\\src\\srcFile_LIEFERANT.xlsx"    # Definiert das Excel file das gelesen werden soll
dstFile = os.getcwd()+"\\dst\\dstFile_LIEFERANT.xlsx"    # Definiert das Excel file das geschrieben werden soll
...
""" # Zu Testzwecken mit festen Werten versehen
idx = ord("b") - 96  - 1                # idx legt den Index fest der bearbeitet werden soll
maxColumn = ord("b") - 96             # maxColumn legt fest, bis zu welcher Spalte das File ausgelesen wird
 """